...
| Gemini CLI  | Install [Gemini CLI](https://github.com/google-gemini/gemini-cli), then run `gemini`.        |
...
[Claude](./providers-claude.md), [Gemini CLI](./providers-gemini.md),
[OpenCode](./providers-opencode.md), and
