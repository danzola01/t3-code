              ...
              <TooltipTrigger
                render={
                  <button
                    ...
                    className="inline-flex size-5 items-center justify-center rounded text-muted-foreground/55 hover:bg-muted/60 hover:text-foreground disabled:opacity-35"
                    onMouseDown={(event) => event.preventDefault()}
                    onClick={() => void refreshRefsFromGit()}
                  />
                }
              >
                <RefreshIcon aria-hidden="true" size="sm" refreshing={isRefreshingRefs} />
              </TooltipTrigger>
