                    ...
                    <EnvironmentMachineIcon
                      kind={
                        scopedEnvironment === null
                          ? "server"
                          : resolveEnvironmentMachineKind(scopedEnvironment.serverConfig)
                      }
                    ...
                    >
                      <MenuRadioItem value="all" closeOnClick>
                        <span className="flex min-w-0 items-center gap-2">
                          <EnvironmentMachineIcon kind="server" className="size-4 shrink-0" />
                          <span className="min-w-0 truncate">All environments</span>
                        </span>
                      </MenuRadioItem>
                      {environments.map((environment) => (
                        ...
                        >
                          <span className="flex min-w-0 items-center gap-2">
                            <EnvironmentMachineIcon
                              kind={
                                environmentMachineById.get(environment.environmentId) ?? "server"
                              }
                              className="size-4 shrink-0"
                            />
