...
export const Gemini: Icon = (props) => {
  ...
  const blueFilterId = `${id}-gemini-b`;
  const yellowFilterAId = `${id}-gemini-c`;
  const yellowFilterBId = `${id}-gemini-d`;
  const redFilterAId = `${id}-gemini-e`;
  const redFilterBId = `${id}-gemini-f`;
  const greenFilterAId = `${id}-gemini-g`;
  const greenFilterBId = `${id}-gemini-h`;
